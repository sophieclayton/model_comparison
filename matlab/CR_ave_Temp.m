...
for m=1:12;
monthly=zeros(360,160,23);
    for day=startday(m):endday(m);
    U=zeros(360,160,23);
        
        for hourly=i((day*4)-3):6:i(day*4);
           inU=sprintf('/scratch/heimbach/ecco/run_c61/diag_iter73_dir_forw_6hr_all/dir_forw_DDtheta/DDtheta.00000%05d.data',hourly);
...
%     out=sprintf('/scratch/sclayton/coarse_rerun/extract/Temp/Temp_daily.1999.%04d.data',day);
...
%     outm=sprintf('/scratch/sclayton/coarse_rerun/extract/Temp/Temp_monthly.1999%02d.data',m);
...
annual=annual./12;
outa='/scratch/sclayton/coarse_rerun/extract/Temp/Temp.1999.data';

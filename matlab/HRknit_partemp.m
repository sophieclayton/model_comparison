% script to make global annual averaged U, V fields from tiled cube-sphere ECCO2 model output fields
   ...
   function [par,temp]=HRknit_par(it,tnz);
...
% read in tiled files
in=sprintf('/scratch/jahn/ecco2/cube84/tiles/L30/res_&04d/PAR/PAR_day.%010d.%03d.001.data',itile,it,itile+1);

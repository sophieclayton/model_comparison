...
% import original E2 file   
in=('/scratch/jahn/run/ecco2/cube84/input/nonneg/ECCO-GODAE+arctic49_phyav_cube66_nonneg.bin');
phiall=readbin(in,[3060,510,50]);

% loop over all depths
fooall=zeros(360,160,50);
...
% Write out the field
fn=sprintf('/scratch/sclayton/HR2CR_initial/%s.data',outfpref);

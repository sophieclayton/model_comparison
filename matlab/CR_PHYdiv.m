...
fid=fopen('/scratch/sclayton/coarse_rerun2/PHYFlux/WPHYdiv_mean.1999.data','w','ieee-be');
...
fid=fopen('/scratch/sclayton/coarse_rerun/PHYFlux/WPHYdiv_anom.1999.data','w','ieee-be');

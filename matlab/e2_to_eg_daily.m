...
for it=184176:72:210384;
    in=sprintf('/scratch/jahn/ecco2/cube84/assembled/L1/ETAN/ETAN_day.%010d.data',it);
    ...
    % Write out the field
    day=day+1;
    fn=sprintf('/scratch/sclayton/HR2CRdata/%s/%s.%04d.1999.data',outfpref,outfpref,day);
    fid=fopen(fn,'w','ieee-be');
    fwrite(fid,fooall,'float32');
    fclose(fid);
    
    ave=ave+fooall;
    clear phiall fooall    in
    day
end

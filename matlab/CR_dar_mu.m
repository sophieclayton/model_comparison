...
munetP=muP-mortP-grazP;
ave_munetP=ave_munetP+munetP;

day
% outmu=sprintf('/scratch/sclayton/coarse_rerun2/extract/MU_MORT_GRAZ/MUnet.%04d.1999.data',day);
% outfid=fopen(outmu,'w','ieee-be');
% fwrite(outfid,munetP,'real*4');
% fclose(outfid);

end % day

ave_munetP=ave_munetP./365;

...
case 3; lons=[-81 -77]; lats=[28 26]; name='Florida Strait';
case 4; lons=[-81 -79]; lats=[28 22]; name='Florida Strait W1';
case 5; lons=[-76 -76]; lats=[21 8]; name='Florida Strait S1';
case 6; lons=[-77 -77]; lats=[26 24]; name='Florida Strait E1';
case 7; lons=[-77 -77]; lats=[24 22]; name='Florida Strait E2';
...
case 22; lons=[-76 -72]; lats=[21 18.5]; name='Florida Strait E3';
case 23; lons=[-72 -72]; lats=[18.5 10]; name='Florida Strait E4';
end;

...
global domainPeriodicity; 
if isempty(domainPeriodicity); 
...
fprintf('  assumes 0 periodicity, except that if the first dimension has n*360 \n');
...
if mod(size(fld,1),360)==0; 
  domainPeriodicity=[1 0];
else; 
  domainPeriodicity=[0 0];
end;
end;

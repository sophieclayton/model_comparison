...
% 
% for day=1:yday;
HR=HRgroup;%readbin('/scratch/sclayton/high_res/Nuts/AveSurfNutrients.1999.data',[3060 510 21]);
  %for tr=1:21; 
%         in=sprintf('/scratch/sclayton/high_res/SIarea/SIarea.%04d.%04d.data', year,day);
%         phiall=
        %in=sprintf('/scratch/sclayton/high_res/global.intr.ann/intrTRAC%02d/TRAC%02d.1999.data', tr, tr);
        %phiall=readbin(in,[3060,510]);
        phiall=HR;%squeeze(HR(:,:,tr));

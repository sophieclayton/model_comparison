function [fldDIV]=calc_UV_div(fldU,fldV,varargin);
%function [fldDIV]=calc_UV_div(fldU,fldV,varargin);
%  => computes the horizontal divergence of fldU,fldV  that may be
...
if nargin==3; list_factors=varargin; else; list_factors={'dh'}; end;
...
else; error('error in calc_UV_div: non supported field size\n');
end;

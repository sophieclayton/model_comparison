function [u]=HRknit_MunetPave(z);% script to make global annual averaged U, V, W fields from tiled cube-sphere ECCO2 model output fields
...
u=zeros(tnx,ntx,nfc,tny,nty,np);
...
% read in tiled files
in=sprintf('/scratch/sclayton/high_res/MU/munetP.1999.%03d.001.data',itile+1);
